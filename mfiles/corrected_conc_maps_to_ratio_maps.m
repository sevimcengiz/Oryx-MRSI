%% This function generates CSF corrected concentration Maps to ratios of all metabolites. 
% Inputs: P info struct
% CSF corrected concentration maps to ratio maps results will be under
% ~nifti/corrected_conc_maps_to_tCr_ratio and ~nifti/corrected_conc_maps_to_Ins_ratio folders as a nifti format.
