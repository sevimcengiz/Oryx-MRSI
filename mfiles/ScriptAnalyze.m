...
function [alltable_mean, alltable_median, alltable_std]=ScriptAnalyze(Pinfo,atlaspath,exclusionval,T_selected)
...
for j=1:max_val
   ...
   alltablename=T_selected{j,2}{1,1};
...
writecell(alltable_mean,([foutpath,filesep,Pinfo.sparname,'_Table_Mean_',atlasname{1,1},'_',num2str(exclusionval),'_perc.csv']));
writecell(alltable_median,([foutpath,filesep,Pinfo.sparname,'_Table_Median_',atlasname{1,1},'_',num2str(exclusionval),'_perc.csv']));
writecell(alltable_std,([foutpath,filesep,Pinfo.sparname,'_Table_Std_',atlasname{1,1},'_',num2str(exclusionval),'_perc.csv']));
