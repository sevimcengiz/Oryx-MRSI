%% This function is written to create binary mask volumes of FOV with the same dimensions of the reference anatomical image volume.
...
% Inputs: Pinfo struct, metabolite number (k), FOV box mask file path,
...
function [Pinfo] = Mask_FOV_run_Pinfo(Pinfo,MRIFOVMask_file,RFOV_dir)
...
ap_off =Pinfo.voxoffap;
lr_off = Pinfo.voxofflr;
cc_off = Pinfo.voxoffcc;
